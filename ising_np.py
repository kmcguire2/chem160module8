...
while Temp<50.:
    ...
    spins = np.full((n,n),1) #n by n region filled with 1
    ...
    for trial in range(1,(ntrials+nequil+1)):
        ...
        if trial == nequil:
            ...
            for i in range(n):
                for j in range(n):
                    #for each spin, subtract from the running total, the energy that were creating,
                    #the spin times the sum of the neighboring spins minus the spin of the ij-th spin
